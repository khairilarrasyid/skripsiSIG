    ...
    <main id="ts-main">
        ...
        <section id="gallery-carousel" class="">
            ...
            <div class="owl-carousel ts-gallery-carousel ts-gallery-carousel__multi" data-owl-dots="1" data-owl-items="3"
                ...
                <!--Slide-->
                <div class="slide">
                    <div class="ts-image" data-bg-image="{{ Storage::url('destinations/' . $penginapan->image) }}">
                        <a href="{{ Storage::url('destinations/' . $penginapan->image) }}" class="ts-zoom popup-image"><i
                                class="fa fa-search-plus"></i>Zoom</a>
                    </div>
                </div>

                @foreach ($penginapan->galleries as $foto)
                    <div class="slide">
                        ...
                        <section id="location">
                            ...
                            <div class="ts-box p-0">
                                <div class="ts-map ts-map__detail" id="ts-map-simple"
                                    ...
                                    data-ts-map-zoom="12" data-ts-map-center-latitude="{{ $penginapan->latitude }}"
                                    data-ts-map-center-longitude="{{ $penginapan->longitude }}"
                                    data-ts-map-scroll-wheel="1" data-ts-map-controls="0"></div>

                                <div class="p-3 ts-text-color-light text-center">
                                    <a href='https://www.google.com/maps/dir/?api=1&penginapan={{ $penginapan->latitude }},{{ $penginapan->longitude }}'
                                        target="_blank">
                    ...
                    <div class="col-md-7 col-lg-8">
                        ...
                        <section id="description">
                            ...
                            <dl class="ts-description-list__line mb-0">
                                ...
                                <dt>Kategori:</dt>
                                <dd class="border-bottom pb-2">{{ $penginapan->category->name }}</dd>
                                ...
                                <dd class="border-bottom pb-2">{{ $penginapan->opening_hours }} </dd>
                    ...
                    <div class="offset-lg-4 col-sm-12 col-lg-8">
                        ...
                        @foreach ($lainnya as $row)
                            ...
                            <div class="card ts-item ts-item__list ts-card">
                                <!--Card Image-->
                                <a href="{{ route('penginapan.detail', $row->id) }}" class="card-img"
                                ...
                                <!--Card Footer-->
                                <a href="{{ route('penginapan.detail', $row->id) }}" class="card-footer">

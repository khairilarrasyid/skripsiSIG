...
@section('content')
    <form id="create-form" action="{{ route('tour-guides.update', $tourGuide->id) }}" method="POST"
            ...
            <div class="d-md-flex m-b-15 align-items-center justify-content-between">
                <div class="media align-items-center m-b-15">
                    <div class="avatar avatar-image rounded" style="height: 70px; width: 100px">
                        <div id="imagePreview">
                            @if ($tourGuide->foto)
                                <img src="{{ Storage::url('tour-guide/' . $tourGuide->foto) }}" alt="Preview"
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama"
                            name="nama" value="{{ old('nama', $tourGuide->name) }}" required>
                        @error('nama')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="phone" name="phone"
                            value="{{ old('phone', $tourGuide->phone) }}" required>
                        @error('phone')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('alamat') is-invalid @enderror" id="alamat"
                            name="alamat" value="{{ old('alamat', $tourGuide->address) }}" required>
                        @error('alamat')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div id="deskripsi">
                            {!! old('deskripsi', $tourGuide->decription) !!}
                        </div>
                        <input type="hidden" id="quill_html" name="deskripsi" value="{{ old('deskripsi', $tourGuide->decription) }}">
                        @error('deskripsi')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>

...
@section('page_js')
    ...
    <script>
        $(document).on('click', '.edit-form-modal', function(e) {
            ...
            var urlForm = "{{ route('users.update', ':id') }}";
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#edit-form input[name="nama"]').val(response.name);
                    $('#edit-form input[name="email"]').val(response.email);
                }
            });
        });
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    @if ($row->id != Auth::user()->id)
                                        <button class="btn btn-icon btn-hover btn-sm btn-rounded pull-right edit-form-modal"
                                            data-toggle="modal" data-target="#edit-form-modal" id="{{ $row->id }}">
